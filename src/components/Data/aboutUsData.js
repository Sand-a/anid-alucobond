export const aboutUsData = [
  {
    headline: "Who is ANID?",
    bodytext:
      "ANID, founded in 1980 by Andre Anid, in Lebanon. We are specialized in Design, Supply, Fabrication and Installation of ALUCOBOND® cladding and aluminium works. We are the exclusive distributor of ALUCOBOND® since 1980. The 1st and original ACP, Aluminium Composite Panel, made in Germany. From Inspiration to Assembly: Our goal is to provide the Best Architectural Solutions in the most efficient and effective way.",
    image: "/images/aboutus/img-0.jpg",
    link: "Our services",
    path: "/services",
  },
  {
    headline: "WHAT IS ALUCOBOND​‌®?",
    bodytext:
  ...
  {
    headline: "HOW TO BUILD WITH ALUCOBOND​‌®",
    bodytext:
