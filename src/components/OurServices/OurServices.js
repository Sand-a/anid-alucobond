      ...
      <div className="section-services ">
        <div className="container query-container">
          ...
          <p className="bodytext">
            ...
            also unique form and colour concepts can easily be implemented using
            the wide product range of ALUCOBOND®.<br></br>
            Possibility of project specific mock-ups including technical
            feasibility tests.<br></br>
            Custom colours are available upon special request subject to minimum
            order quantities.
          </p>
        </div>
